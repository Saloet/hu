...
<body>
    <h1 style='color: #A52A2A'>База даних "Наш Банк" таблиця credit</h1>
    <table>
        <tr>
            <th>ID</th>
            <th>Number</th>
        ...
        <?php
            ...
            $banks = mysqli_query($connect, "SELECT * FROM `credit`");
        ...
        <form action="vendor/create.php" method="POST">
            ...
            <p>Id_cashout</p>
            <input type="number" name="tele_number" placeholder="Id_cashout"> <br> <br>
